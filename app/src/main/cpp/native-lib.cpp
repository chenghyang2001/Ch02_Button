...
Java_tw_com_flag_ch02_ASRListener_goHomeJNI(
        JNIEnv *env,
        jobject /* this */) {


    ALOG(ANDROID_LOG_INFO, TAG ,"xxx yyy 11 will use sendenv to emulate HOME key ");
...
//    system("sendevent /dev/input/event2 0   0 0");
    ...
    ALOG(ANDROID_LOG_INFO, TAG ,"xxx yyy 22 will use sendenv to emulate HOME key ");
